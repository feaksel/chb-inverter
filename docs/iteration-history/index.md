...
<figure markdown="span">
  ![Demo stand — the as-built iteration 4](../assets/images/demo-stand-wired.jpeg){ loading=lazy width=80% }
  <figcaption>The as-built iteration 4 on the demo stand — what the project converged to after three earlier rounds.</figcaption>
</figure>
...
The project's headline result — **5 distinct cascade levels visible on the scope at 100 V output, both bridges thermally matched** — is not what iteration 1 produced. It took three rounds of bench-discovered failures and one re-architecture to reach.
