...
| 8 | Oscilloscope captures (gate, dead-time, 5-level out, thermal) | 🟡 | 2 PWM scope captures uploaded (`scope-pwm-initial.jpeg`, `scope-pwm-cascade-output.jpeg`). Dead-time-edge zoom + thermal scan still pending. |
...
| # | Artifact | Status | Notes |
|---|---|---|---|
| 13 | RISC-V SoC RTL + GDSII | ⏳ | Will live under `experimental/risc-v-soc/`. ELE419 Fall 2025 report imported for context (`docs/assets/pdfs/ELE419_Fall2025_Report.pdf`); RTL/GDSII still needed. |
| 14 | Team photo / supervisor info for About page | ⏳ | Phase 7 — text in About page already in place |
| 15 | Hacettepe University logo (with usage rights) | ⏳ | Optional. |
